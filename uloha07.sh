                ...
                case "$CMD" in
                        ...
                        RETR)
                                if [ $nc_pid -eq 0 ]; then
                                        ...
                                        echo "150 Here comes the file requested"
                                        if [ cat "$ARG" >&4 ]; then                     # predpokladam ze v ARG je cela cesta k souboru
                                                echo "226 file transfer succesful"
                                        else echo "4xx something went wrong"
                                        fi
                                        exec 3<&- 4>&-
                                        rm "$FIFO_IN" "$FIFO_OUT"
                                        port=0
